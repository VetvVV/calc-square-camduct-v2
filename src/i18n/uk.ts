export const uk = {
  ...
  home: {
    ...
    openRound: 'Робоча зона KRG-001',
    openSpiral: 'Робоча зона R-sp-001',
    openRoundDuct: 'Робоча зона: KRG-001',
    ...
    mvpR001: 'KRG-001: повітропровід круглий / труба прямошовна, площа та розбиття по 1250 мм.',
    ...
    capabilityR001: 'KRG-001: розрахунок площі та технологічне розбиття по 1250 мм.',
  ...
  product: {
    ...
    roundDuctStraight: 'Повітропровід круглий / труба прямошовна',
    ...
    rectDuct: 'Повітропровід прямокутний',
