export const ru = {
  ...
  home: {
    ...
    openRound: 'Рабочая зона KRG-001',
    openSpiral: 'Рабочая зона R-sp-001',
    openRoundDuct: 'Рабочая зона: KRG-001',
    ...
    mvpR001: 'KRG-001: воздуховод круглый / труба прямошовная, площадь и разбиение по 1250 мм.',
    ...
    capabilityR001: 'KRG-001: расчёт площади и технологическое разбиение по 1250 мм.',
